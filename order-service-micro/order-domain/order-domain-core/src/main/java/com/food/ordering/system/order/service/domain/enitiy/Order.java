...
public class Order extends AggregateRoot<OrderId> {
    ...
    private void validateItemsPrice() {
        ...
        }).reduce(Money.ZERO, (i, j) -> i.add(j));

        if (!price.equals(orderItemsTotal)) {
            throw new OrderDomainException("Total price: " + price.getAmount()
                    + " is not equal to the OrderItems total: " + orderItemsTotal.getAmount() + "!");
        }
    }
    ...
    public void pay() {
        if (orderStatus != OrderStatus.PENDING) {
            throw new OrderDomainException("Order is not in the correct state for to pay operation!");
        }
    ...
    public void approve() {
        if (orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order is not in the correct state for to approve operation!");
        }
    ...
    private void updateFailureMessages(List<String> failureMessages) {
        ...
        if (this.failureMessages == null && failureMessages != null) {
            this.failureMessages = failureMessages.stream().filter(msg -> !msg.isEmpty()).collect(Collectors.toList());
        }
    }
