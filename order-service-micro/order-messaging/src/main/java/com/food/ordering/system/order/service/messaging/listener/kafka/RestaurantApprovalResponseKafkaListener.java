    ...
    public void receive(@Payload List<RestaurantApprovalResponseAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
            try {
                ...
                //NO-OP for optimistic lock. This means another thread finished the work, do not throw error to prevent the data from kafka again!
                log.error("Error optimistic locking exception in RestaurantApprovalResponseKafkaListener for order id: {}",
                        restaurantApprovalResponseAvroModel.getOrderId());
            }
