...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<K, V>> kafkaListenerContainerFactory() {
        ...
        concurrentKafkaListenerContainerFactory.setBatchListener(kafkaConsumerConfigData.getBatchListener());
        concurrentKafkaListenerContainerFactory.setConcurrency(kafkaConsumerConfigData.getConcurrencyLevel());
        concurrentKafkaListenerContainerFactory.setAutoStartup(kafkaConsumerConfigData.getAutoStartup());
        concurrentKafkaListenerContainerFactory.getContainerProperties().setPollTimeout(kafkaConsumerConfigData.getPollTimeoutMs());
